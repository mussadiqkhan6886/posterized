    ...
    <section className='max-w-[1240px] mx-auto my-10'>
      ...
      <div className='grid grid-cols-3 gap-6'>
        {exploreSections.map(item => (
            <div key={item.title}>
                <Image src={item.image} alt={item.title} width={400} height={400} className='object-center object-cover cursor-pointer hover:saturate-100 saturate-50 duration-200 ' />
      ...
      <div className='relative my-10'>
        ...
        <div className='absolute bottom-10 text-white left-10'>
            <h4 className='text-5xl font-bold'>Design Your Own</h4>
            <p className='font-base font-medium my-2 max-w-xl tracking-tight'>With our visualization tool, you can experiment endlessly with colors, sizes and layouts until you have designed the art of your dreams</p>
            <Link href='/' className='border-b border-white pb-1 font-semibold text-lg' >Try Now</Link>
        </div>
      </div>
    </section>
  )
